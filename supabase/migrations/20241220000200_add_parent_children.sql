...
DROP POLICY IF EXISTS "Parents can invite children" ON parent_children;
...
DROP POLICY IF EXISTS "Parents can update their settings" ON parent_children;
...
DROP POLICY IF EXISTS "Parents can revoke access" ON parent_children;
